...
<head>
    ...
    <style>
        ...
        input, select, textarea { width: 100%; padding: 12px; margin: 8px 0; border: 1px solid #ddd; border-radius: 10px; box-sizing: border-box; outline: none; }
...
<script>
    // إعدادات Firebase الصحيحة بناءً على بياناتك
    ...
    function sendOTP() {
        ...
        if(!user || !phone) return alert("يرجى إكمال البيانات");
