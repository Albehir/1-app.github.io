...
<body>
    ...
    <script>
        ...
        async function handleAuth() {
            ...
            try {
                if (email) {
                    // التحقق عبر الإيميل (إرسال رابط سحري)
        ...
        // التعامل مع رابط الإيميل عند العودة للموقع
